...
ws.onopen = () =>{
    ...
    checkChannel();
    ws.send(channel);
    alert('Please, after some second, write !start in your chat, to start integration with twitch, and if you want to give your  moderators ability to shutdown game - than write in your chat "!mods"')
};
function checkChannel(){
    channel ='#' +prompt('Please, write your channel name/twitch ID. Sorry if you are null channel. Try use uppercase N than.');
    if (channel === '#null') {
        if (trys < 1) {
            checkChannel();
            trys++;
           ...
           alert('If you wan\'t to sign your channel later -  get back to the main page or refresh it.')
